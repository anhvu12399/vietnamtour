...
export default function GlobalError({
  ...
  return (
    <html>
      <body style={{ padding: '2rem', fontFamily: 'sans-serif', backgroundColor: '#1e293b', color: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        <div style={{ maxWidth: '800px', width: '100%', backgroundColor: '#0f172a', padding: '2rem', borderRadius: '8px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}>
          <h2 style={{ color: '#ef4444', marginTop: 0 }}>Global Application Error (Layout)</h2>
