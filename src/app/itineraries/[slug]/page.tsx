                ...
                {itinerary.timeline.map((item, idx) => (
                  <div key={idx} className="relative space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <h3 className="font-serif text-lg sm:text-xl text-luxury-linen font-medium">
                        {item.title}
                      </h3>
                    </div>
                      ...
                      <div className="pt-2">
                        {typeof item.accommodation === 'object' ? (
                          <div className="inline-flex items-center space-x-3 bg-luxury-moss/50 border border-luxury-moss/60 p-3 px-4">
                            <span className="text-[10px] uppercase tracking-wider text-luxury-linen/50">Stay:</span>
                            <span className="text-xs font-semibold text-luxury-linen">{item.accommodation.name}</span>
                            <span className="text-[10px] bg-luxury-gold/20 text-luxury-linen px-2 py-0.5 rounded-none font-medium">
                          ...
                          <div className="inline-flex items-center space-x-2 bg-luxury-moss/50 border border-luxury-moss/60 p-2 px-3 text-xs">
                            <span className="text-[10px] uppercase tracking-wider text-luxury-linen/50">Stay:</span>
                            <span className="font-medium text-luxury-linen">{item.accommodation}</span>
                          </div>
                        )}
                      </div>
                    )}
          ...
          <div className="space-y-10">
            ...
            <div className="bg-luxury-moss border border-luxury-moss p-8 text-center space-y-6 shadow-sm">
              <div className="space-y-2">
                ...
                <h3 className="font-serif text-lg text-luxury-linen font-semibold">
              ...
              <div className="pt-4 border-t border-luxury-slate space-y-4">
                ...
                <div className="text-xs space-y-1.5 pt-2">
                  <p className="text-luxury-linen/50">Direct Phone: <span className="font-semibold text-luxury-linen">{itinerary.specialist.phone}</span></p>
                  <p className="text-luxury-linen/50">Email: <span className="font-semibold text-luxury-linen">{itinerary.specialist.email}</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-luxury-moss p-8 space-y-4">
              ...
              <ul className="space-y-3 text-xs sm:text-sm font-light text-luxury-linen/80">
                <li className="flex justify-between py-1 border-b border-luxury-moss/50">
                  <span className="text-luxury-linen/50">Pacing:</span>
                  <span className="font-medium">Relaxed / Luxury</span>
                </li>
                <li className="flex justify-between py-1 border-b border-luxury-moss/50">
                  <span className="text-luxury-linen/50">Primary currency:</span>
                  <span className="font-medium">£ GBP (UK Market)</span>
                </li>
                <li className="flex justify-between py-1 border-b border-luxury-moss/50">
                  <span className="text-luxury-linen/50">Best Season:</span>
                  <span className="font-medium">Oct to Apr</span>
                </li>
                <li className="flex justify-between py-1">
                  <span className="text-luxury-linen/50">Protection:</span>
