            ...
            {inspirationsData.map((item) => (
              ...
              >
                ...
                <div className="relative h-60 overflow-hidden shrink-0 bg-slate-100">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-slate-950/90 backdrop-blur-xs text-white text-[9px] uppercase tracking-widest font-semibold px-3 py-1.5 rounded-none border border-white/10">
                    {item.category}
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 flex flex-col justify-between flex-grow space-y-6">
                  ...
                  <div className="space-y-2 pt-2 border-t border-slate-100">
                    <span className="text-[10px] uppercase tracking-wider text-slate-400 font-semibold block">Exclusive Features:</span>
                  ...
                  <div className="pt-4">
                    <Link
                      ...
                      className="inline-flex items-center space-x-2 text-xs uppercase tracking-widest font-bold text-[#c5a880] hover:text-slate-990 transition-colors"
                    >
