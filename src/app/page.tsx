        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div 
                key={idx} 
                className="flex flex-col bg-luxury-slate border border-luxury-gold/10 hover:border-luxury-gold/40 transition-all duration-500 shadow-2xl relative group pt-8"
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <Image
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-luxury-slate/50 to-transparent" />
                </div>

                {/* Bullet details */}
                <div className="p-6 flex-grow space-y-3 bg-luxury-moss/20">
