      ...
      <main className="min-h-screen bg-luxury-slate text-luxury-linen">
        ...
        <section className="relative h-[380px] sm:h-[460px] lg:h-[540px] w-full flex items-end justify-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-12 sm:pb-16">
            ...
            {/* Meta row */}
            <div className="flex items-center gap-5 mt-5 text-[10px] uppercase tracking-widest font-medium text-luxury-linen/50">
        ...
        <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <article className="lg:col-span-8">
              ...
              {/* Drop-cap Intro */}
              <div className="mb-12 pb-8 border-b border-luxury-gold/10">
                ...
                <div className="drop-cap-intro">
                  <p className="text-base sm:text-[17px] font-light text-luxury-linen/90 leading-relaxed">
                    {thing.intro}
                  </p>
                </div>
              </div>
              ...
              {/* Highlights strip */}
              <div className="mb-12 bg-luxury-slate/40 border border-luxury-gold/10 p-6 sm:p-8">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {thing.highlights.map((hl, i) => (
                    <li key={i} className="flex items-start gap-2.5 text-sm text-luxury-linen/80 font-light">
              ...
              {thing.sections.map((section, idx) => (
                <div key={idx} className="mb-14">
                  <h2 className="font-serif text-2xl sm:text-3xl text-luxury-linen font-semibold leading-tight mb-6 pb-4 border-b border-luxury-gold/10">
                    {section.heading}
                  </h2>

                  {/* Body paragraphs */}
                  {section.body.split('\n\n').map((para, pi) => (
                    <p key={pi} className="text-base sm:text-[17px] font-light text-luxury-linen/85 leading-relaxed mb-6">
                      {para}
                    </p>
                  ))}
                  ...
                  {/* Section image */}
                  {section.image && (
                    <div className="my-8 border border-luxury-gold/10 p-1.5 bg-luxury-slate/20">
                      ...
                      {section.imageCaption && (
                        <p className="text-[10px] text-luxury-linen/45 uppercase tracking-widest text-center mt-3 font-light px-2">
                          {section.imageCaption}
                        </p>
                      )}
                    </div>
              ...
              {/* Share strip */}
              <div className="mt-10 pt-8 border-t border-luxury-gold/10 flex items-center gap-4">
                <span className="text-[10px] uppercase tracking-widest font-bold text-luxury-linen/35">Share</span>
                {['Facebook', 'X (Twitter)', 'Email'].map((sn) => (
                  <span key={sn} className="text-[10px] uppercase tracking-widest font-bold text-luxury-gold hover:text-luxury-linen transition-colors cursor-pointer">{sn}</span>
                ))}
              </div>
            </article>
            ...
            <aside className="lg:col-span-4 space-y-6 sticky top-28">
              ...
              {/* Practical Info Card */}
              <div className="bg-luxury-slate/40 border border-luxury-gold/10 p-6 space-y-4">
                <h3 className="font-sans text-[10px] uppercase tracking-[0.3em] font-bold text-luxury-gold border-b border-luxury-gold/10 pb-3">
                ...
                {[
                  ...
                  <div key={item.label}>
                    ...
                    <span className="text-xs text-luxury-linen/80 font-light leading-relaxed">
                      {item.value}
                    </span>
                  </div>
                ))}
              ...
              <div className="bg-luxury-slate/30 border border-luxury-gold/10 p-7 flex flex-col items-center text-center space-y-4">
                <span className="text-[9px] uppercase tracking-[0.3em] font-bold text-luxury-gold block">
                  Plan this experience
                </span>
                <h3 className="font-serif text-base font-semibold text-luxury-linen leading-snug">
                  Speak to a Vietnam specialist
                </h3>
                <div className="relative w-20 h-20 rounded-full overflow-hidden border border-luxury-gold/15 shadow-md shrink-0">
                  <Image src="/images/specialist_alice.png" alt="Alice Mercer" fill className="object-cover" />
                </div>
                <div className="space-y-0.5">
                  <h4 className="font-sans text-xs font-bold text-luxury-linen uppercase tracking-wider">Alice Mercer</h4>
                  <p className="text-[11px] text-luxury-linen/55 font-light">Senior Vietnam Travel Specialist</p>
                </div>
                <Link
                  href="/enquire"
                ...
                <div className="pt-1 border-t border-luxury-gold/10 w-full flex flex-col items-center">
                  <span className="text-[9px] uppercase text-luxury-linen/35 font-bold tracking-widest block mb-1">Or call us</span>
                  <a href="tel:+442078459200" className="text-sm font-bold text-luxury-linen hover:text-luxury-gold transition-colors">
                    +44 (0) 20 7845 9200
                  </a>
                </div>
              </div>
        ...
        {recommendedTours.length > 0 && (
          <section className="py-16 px-6 lg:px-12 bg-luxury-slate/20 border-t border-luxury-gold/10">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-10 mb-10 border-b border-luxury-gold/10">
                ...
                <Link
                  href="/itineraries"
                  className="text-xs uppercase tracking-widest font-bold text-luxury-gold hover:text-luxury-linen transition-colors pb-1 border-b border-luxury-gold/30 hover:border-luxury-gold self-start sm:self-end"
                >
                  View all tours
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {recommendedTours.map((it) => (
                  <div key={it._id} className="group bg-luxury-slate/30 border border-luxury-gold/10 hover:border-luxury-gold/30 transition-all duration-300 hover:shadow-xl flex flex-col">
                    ...
                    <div className="p-5 space-y-2 flex-grow">
                      ...
                      <h4 className="font-serif text-base leading-snug font-semibold text-luxury-linen group-hover:text-luxury-gold transition-colors">
                        <Link href={`/itineraries/${it.slug?.current || ''}`}>{it.title}</Link>
                      </h4>
                      {it.duration && it.priceFrom && (
                        <p className="text-xs font-medium text-luxury-linen/55">
                          {it.duration} days from <span className="text-luxury-gold">£{it.priceFrom.toLocaleString('en-GB')}pp</span>
                        </p>
                      )}
                    </div>
                    <div className="px-5 py-3.5 border-t border-luxury-gold/10 flex items-center justify-between text-xs font-semibold bg-luxury-slate/40">
                      <Link href={`/itineraries/${it.slug?.current || ''}`} className="text-luxury-linen/65 hover:text-luxury-gold transition-colors">
                        View itinerary
                      </Link>
        ...
        ════════════════════════════════════════════ */}
        {crossLinks.length > 0 && (
          <section className="py-16 px-6 lg:px-12 bg-[#121816] border-t border-white/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {crossLinks.map((item) => (
                  <Link
                    ...
                    className="group relative h-60 overflow-hidden border border-white/10 hover:border-luxury-gold/30 flex flex-col justify-end bg-luxury-slate/40 transition-all duration-300"
                  >
                    <Image
                      src={item.heroImage}
                      alt={item.title}
        ...
        <section className="py-20 px-6 lg:px-12">
          <div className="max-w-3xl mx-auto bg-luxury-slate/30 border border-luxury-gold/10 p-10 sm:p-16 text-center space-y-8 shadow-xl">
            ...
            <p className="text-sm text-luxury-linen/60 font-light max-w-xl mx-auto leading-relaxed">
              {thing.ctaBody}
            </p>
