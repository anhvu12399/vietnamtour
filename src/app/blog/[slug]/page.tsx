              ...
              {post.ctaHeading && (
                <div className="max-w-4xl mx-auto text-center bg-luxury-slate p-12 lg:p-20 rounded-2xl border border-[#e6e2d6] relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <Link href="/enquire" className="inline-flex items-center justify-center px-8 py-4 bg-luxury-gold text-[#161C1A] hover:bg-white transition-colors uppercase tracking-wider text-sm font-bold">
                      Enquire Now
                    </Link>
                  </div>
                </div>
