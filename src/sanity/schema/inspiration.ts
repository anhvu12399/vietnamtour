...
export const inspiration = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Page Title',
      type: 'string',
      description: 'Main H1 heading (e.g., Vietnam Luxury Tours: The Ultimate Private Travel Experience)',
    ...
    defineField({
      ...
      title: 'URL Slug',
      type: 'slug',
      description: 'The URL path (e.g., /inspirations/luxury-tours)',
      options: {
        source: 'title',
        maxLength: 96,
      },
    ...
    defineField({
      ...
      type: 'string',
      description: 'e.g. LUXURY, ADVENTURE',
      group: 'hero',
    }),
    defineField({
      name: 'breadcrumb',
      ...
      type: 'string',
      description: 'Short name for breadcrumbs (e.g., Luxury Tours)',
      group: 'hero',
    }),
