...
export const tripIdea = defineType({
  name: 'tripIdea',
  title: 'Trip Idea Page',
  type: 'document',
  groups: [
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Page Title',
      type: 'string',
      description: 'Main H1 heading (e.g., Vietnam Culinary Tours: Eat Your Way Through the Country)',
    ...
    defineField({
      ...
      title: 'URL Slug',
      type: 'slug',
      description: 'The URL path (e.g., /trip-ideas/vietnam-culinary-tours)',
      options: {
        source: 'title',
        maxLength: 96,
      },
    ...
    defineField({
      ...
      type: 'string',
      description: 'e.g. CULINARY TOURS, BIKE & BOAT TOURS',
      group: 'hero',
    }),
    defineField({
      name: 'breadcrumb',
      ...
      type: 'string',
      description: 'Short name for breadcrumbs (e.g., Culinary Tours)',
      group: 'hero',
    }),
