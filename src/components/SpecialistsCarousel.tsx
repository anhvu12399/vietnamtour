...
export default function SpecialistsCarousel({ specialists }: SpecialistsCarouselProps) {
  ...
  return (
    <section className="py-24 bg-[#044732] relative overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-4.5xl text-white leading-tight font-medium">
        ...
        <div className="relative flex items-center justify-between px-4 sm:px-8">
          ...
          <button 
            onClick={handlePrev}
            className="absolute left-0 z-20 w-8 h-8 flex items-center justify-center text-white/50 hover:text-white transition-colors cursor-pointer"
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-4 group h-full">
                      {/* Avatar */}
                      <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden flex-shrink-0 border-2 border-white/25 group-hover:border-white/50 transition-colors duration-500 shadow-lg bg-black/20">
                        <Image
                      ...
                      <div className="flex flex-col justify-between py-1 h-full min-h-[96px] sm:min-h-[112px]">
                        <div>
                          <h3 className="font-serif text-lg sm:text-xl text-white font-medium group-hover:text-luxury-gold transition-colors duration-300">
                            {spec.name}
                          </h3>
                          <p className="text-xs sm:text-sm text-white/70 font-light leading-relaxed mt-2 line-clamp-3">
                            {bioText}
                          </p>
                        </div>
                        <div className="mt-2">
                          <Link
                            ...
                            className="text-xs text-white/80 hover:text-white underline hover:no-underline transition-all font-light"
                          >
                            Read more
                          </Link>
                        </div>
          ...
          <button 
            onClick={handleNext}
            className="absolute right-0 z-20 w-8 h-8 flex items-center justify-center text-white/50 hover:text-white transition-colors cursor-pointer"
        ...
        <div className="text-center mt-16">
          <Link
            href="/specialists"
            className="inline-block px-8 py-3 bg-white text-[#044732] hover:bg-transparent hover:text-white border border-white font-semibold text-xs tracking-widest uppercase transition-all duration-300 rounded-none shadow-md"
          >
            Explore Our Experts
          </Link>
        </div>
